...
export const NavigatorSearchResultItemView: FC<NavigatorSearchResultItemViewProps> = props =>
{
    ...
    if(thumbnail) return (
        <Column pointer overflow="hidden" alignItems="center" onClick={ visitRoom } gap={ 0 } className="navigator-item p-1 bg-light rounded-3 small mb-1 flex-column border border-muted gnui-bg-nav-itm-big" { ...rest }>
            ...
            <Flex className="w-100">
                <Text truncate className="flex-grow-1 gnui-nav-itm-big-txt">{ roomData.roomName }</Text>
    ...
    return (
        <Flex pointer overflow="hidden" alignItems="center" onClick={ visitRoom } gap={ 2 } className="navigator-item px-2 py-1 small" { ...rest }>
            ...
            <Text className="gnui-nav-txt-light" truncate grow>{ roomData.roomName }</Text>
            <Flex reverse alignItems="center" gap={ 1 }>
                <NavigatorSearchResultItemInfoView roomData={ roomData } />
