        ...
        <WiredActionBaseView requiresFurni={ WiredFurniType.STUFF_SELECTION_OPTION_NONE } hasSpecialInput={ true } save={ save }>
            ...
            <Column gap={ 1 }>
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite">{ LocalizeText('wiredfurni.params.start.following') }</Text>
                </Flex>
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite">{ LocalizeText('wiredfurni.params.stop.following') }</Text>
                </Flex>
            </Column>
        </WiredActionBaseView>
    );
