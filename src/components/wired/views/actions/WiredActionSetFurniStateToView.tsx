...
export const WiredActionSetFurniStateToView: FC<{}> = props =>
{
    ...
    return (
        <WiredActionBaseView requiresFurni={ WiredFurniType.STUFF_SELECTION_OPTION_BY_ID } hasSpecialInput={ true } save={ save }>
            <Column gap={ 1 }>
                <Text className="gnui-txt-white" bold>{ LocalizeText('wiredfurni.params.conditions') }</Text>
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite">{ LocalizeText('wiredfurni.params.condition.state') }</Text>
                </Flex>
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite">{ LocalizeText('wiredfurni.params.condition.direction') }</Text>
                </Flex>
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite">{ LocalizeText('wiredfurni.params.condition.position') }</Text>
                </Flex>
            </Column>
        </WiredActionBaseView>
    );
