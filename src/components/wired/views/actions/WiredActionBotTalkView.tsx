    ...
    return (
        <WiredActionBaseView requiresFurni={ WiredFurniType.STUFF_SELECTION_OPTION_NONE } hasSpecialInput={ true } save={ save }>
            <Column gap={ 1 }>
                ...
                <input type="text" className="form-control gnui-form-control form-control-sm" maxLength={ 32 } value={ botName } onChange={ event => setBotName(event.target.value) } />
            </Column>
            <Column gap={ 1 }>
                <Text className="gnui-txt-white" bold>{ LocalizeText('wiredfurni.params.message') }</Text>
                <input type="text" className="form-control gnui-form-control form-control-sm" maxLength={ 64 } value={ message } onChange={ event => setMessage(event.target.value) } />
            </Column>
            <Column gap={ 1 }>
                ...
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite">{ LocalizeText('wiredfurni.params.shout') }</Text>
                </Flex>
            </Column>
        </WiredActionBaseView>
    );
