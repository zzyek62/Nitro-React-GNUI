...
export const WiredActionMoveFurniView: FC<{}> = props =>
{
    ...
    return (
        <WiredActionBaseView requiresFurni={ WiredFurniType.STUFF_SELECTION_OPTION_BY_ID_BY_TYPE_OR_FROM_CONTEXT } hasSpecialInput={ true } save={ save }>
            <Column gap={ 1 }>
                <Text className="gnui-txt-white" bold>{ LocalizeText('wiredfurni.params.movefurni') }</Text>
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite">{ LocalizeText('wiredfurni.params.movefurni.0') }</Text>
                </Flex>
                <Flex gap={ 1 }>
            ...
            <Column gap={ 1 }>
                <Text className="gnui-txt-white" bold>{ LocalizeText('wiredfurni.params.rotatefurni') }</Text>
