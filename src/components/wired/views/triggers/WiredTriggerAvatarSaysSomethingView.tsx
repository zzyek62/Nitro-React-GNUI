...
export const WiredTriggerAvatarSaysSomethingView: FC<{}> = props =>
{
    ...
    return (
        <WiredTriggerBaseView requiresFurni={ WiredFurniType.STUFF_SELECTION_OPTION_NONE } hasSpecialInput={ true } save={ save }>
            <Column gap={ 1 }>
                <Text className="gnui-txt-white" bold>{ LocalizeText('wiredfurni.params.whatissaid') }</Text>
                <input type="text" className="form-control gnui-form-control form-control-sm" value={ message } onChange={ event => setMessage(event.target.value) } />
            </Column>
            <Column gap={ 1 }>
                <Text className="gnui-txt-white" bold>{ LocalizeText('wiredfurni.params.picktriggerer') }</Text>
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite" >{ LocalizeText('wiredfurni.params.anyavatar') }</Text>
                </Flex>
                <Flex alignItems="center" gap={ 1 }>
                    ...
                    <Text className="gnui-txt-swhite" >{ GetSessionDataManager().userName }</Text>
                </Flex>
            </Column>
