...
export const ChatlogView: FC<ChatlogViewProps> = props =>
{
    ...
    {
        return (
            <Flex key={ props.uniqueKey } gap={ 2 } alignItems="center" justifyContent="between" className="room-info gnui-item-container border rounded p-1" style={ props.style }>
                <Flex gap={ 1 }>
                    <Text className="gnui-txt-white" bold>Room name:</Text>
        ...
        <>
            ...
            <Column fit gap={ 0 } overflow="hidden">
                ...
                { (records && (records.length > 0)) &&
                    <Column className="log-container gnui-txt-white striped-children" overflow="auto" gap={ 0 }>
