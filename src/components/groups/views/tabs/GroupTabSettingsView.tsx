    ...
    return (
        <Column overflow="auto">
                        ...
                        <Flex key={ index } alignItems="center" gap={ 1 }>
                            ...
                            <Column gap={ 0 }>
                                <Flex gap={ 1 }>
                                    ...
                                    <Text className="gnui-txt-white">{ LocalizeText(`group.edit.settings.type.${ state }.label`) }</Text>
                                </Flex>
                                <Text className="gnui-txt-swhite">{ LocalizeText(`group.edit.settings.type.${ state }.help`) }</Text>
                            </Column>
                        </Flex>
                    );
                }) }
            </Column>
            <HorizontalRule className="gnui-border-trans" />
            <Flex alignItems="center" gap={ 1 }>
                ...
                <Column gap={ 1 }>
                    <Text className="gnui-txt-white">{ LocalizeText('group.edit.settings.rights.caption') }</Text>
                    <Text className="gnui-txt-swhite">{ LocalizeText('group.edit.settings.rights.members.help') }</Text>
                </Column>
            </Flex>
        </Column>
    );
